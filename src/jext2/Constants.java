...
public class Constants {
	...
	public static final int EXT2_FEATURE_COMPAT_SUPP           = EXT2_FEATURE_COMPAT_EXT_ATTR;
	public static final int EXT2_FEATURE_INCOMPAT_SUPP         = (EXT2_FEATURE_INCOMPAT_FILETYPE|EXT2_FEATURE_INCOMPAT_META_BG);
	public static final int EXT2_FEATURE_RO_COMPAT_SUPP        = (EXT2_FEATURE_RO_COMPAT_SPARSE_SUPER|EXT2_FEATURE_RO_COMPAT_LARGE_FILE|EXT2_FEATURE_RO_COMPAT_BTREE_DIR);
	public static final int EXT2_FEATURE_RO_COMPAT_UNSUPPORTED = ~EXT2_FEATURE_RO_COMPAT_SUPP;
	public static final int EXT2_FEATURE_INCOMPAT_UNSUPPORTED  = ~EXT2_FEATURE_INCOMPAT_SUPP;
